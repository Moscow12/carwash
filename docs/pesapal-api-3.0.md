...
Parameter	Type	Required	Description
id 	String 	Required 	This refers to your unique merchant reference generated by your system. NOTE: It should be unique at all times for every order request. The reference must only contain alphanumeric characters, dashes (-), underscores (_), dots (.), and colons (:). Spaces and special characters such as @, #, $, %, &, /, \, ?, =, or any other unsupported symbols are not allowed. Maximum - 50 characters
