        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-0">
          <div>
            <div class="d-flex gap-3 align-items-center border-dashed border-bottom px-4 py-4">
              ...
              <div>
                @auth
                  ...
                  <span class="badge bg-info mt-1">Customer</span>
                @else
            ...
            <div class="p-3 d-flex flex-column gap-1">
              <a href="{{ route('customer.dashboard') }}" class="dropdown-item d-flex align-items-center gap-2">
                <span><i class="ti ti-home-2 fs-5"></i></span>
                <span>Dashboard</span>
              </a>
              <a href="{{ route('customer.bookings') }}" class="dropdown-item d-flex align-items-center gap-2">
                <span><i class="ti ti-calendar-event fs-5"></i></span>
                <span>My Bookings</span>
              </a>
              <a href="{{ route('customer.profile') }}" class="dropdown-item d-flex align-items-center gap-2">
                <span><i class="ti ti-user fs-5"></i></span>
